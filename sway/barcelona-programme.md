...
```mermaid
flowchart TD
  P1["Prep: evening 1, Mon 5 Oct, sealed founder answers v1"]
  P2["Prep: evenings 2 to 4, Tue 6 to Thu 8 Oct, packs, Duel evidence sheet, scope proposal, divergence list"]
  P3["Prep: evenings 2 and 3, Tue 6 and Wed 7 Oct, technical windows A and B, seeded database, build brief v1"]
