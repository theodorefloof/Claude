...
Sunday settles Q4 with fresh heads before a single prompt is typed, spends its 90 minutes of build on fixes and cold runs rather than features, reconciles the commercial drafts with what was actually built, and finishes the final review by 14:00 so that all work ends at 14:30, four hours before the assumed 18:30 departure. Every time below is Barcelona local (CEST). Session IDs, times, roles and outputs are those of the agreed programme skeleton; nothing here adds a session or moves one. Journey roles are written as the advocate (Tori persona in the package documents) and the recipient (Blake persona in the package documents); the founders are Blake and Tory. In the demo, founder Blake plays the advocate and founder Tory plays the recipient, as the skeleton assigns; the names on screen are the prototype persona names chosen at D1-05 (placeholders Maya and Sam), never the founders' names. Where the skeleton is silent on a detail, the simplest option is chosen and marked "(programme choice)".

### 4B.1 Before 09:00: pack, check out, bags held

The room is cleared before the first session so that no working minute is spent on luggage. Both founders pack and check out before 09:00; bags go to the accommodation's storage (ASSUMPTION: bags held free on checkout day, confirmed at the Fri 9 Oct venue check; if the accommodation cannot hold bags, the locker near Plaça de Catalunya booked by Sat 3 Oct is used and 30 minutes are added to the transfer, which removes the reserve). Blake confirms the 14:45 taxi in the app and that the pick-up point is a street a taxi can reach. Tory checks the weather forecast and the Rodalies or metro notices at 08:30 (logistics.md section 11, checklist item 10). Laptop and both phones are charged to full; the power bank is in the day bag, not the held luggage. If the accommodation is booked through Sunday night or a written late checkout exists, packing still happens before 09:00 (programme choice) so that the 14:00 to 14:30 block is packing the room, not the suitcases.

### 4B.2 The Sunday schedule at a glance

The day runs 09:00 to 14:30 against the default ASSUMPTION of an 18:30 departure from BCN by taxi; the final review finishes by 14:00, the founders leave the accommodation by 15:00 and are at the terminal by 16:00.

| Time | Activity | My role (Blake) | Tory's role | Output or decision due |
|---|---|---|---|---|
| Before 09:00 | Pack, check out, bags to storage; taxi pick-up confirmed in the app for 14:45; weather and transport notices checked at 08:30 | Taxi confirmation; laptop and both phones charged | Reception, bags, notices | Bags held; taxi confirmed |
...
| 14:00 to 14:30 | D2-07 Decision log finalised and sent; five answers and output statuses exported as one document; GitHub sync, seed CSVs and both recordings saved; wall paper photographed; room packed; bags collected. TRAVEL CUTOFF: ALL WORK ENDS 14:30 (departure minus 4 hours by taxi) | Lead; exports the prototype pack | Recorder; sends the log and answers | Both founders have the document on their phones; all work ends 14:30 |
| 14:30 to 15:00 | Departure logistics: leave the accommodation by 15:00 (taxi pick-up 14:45; if the taxi is late, the Aerobus from Plaça de Catalunya, 60 minutes door to terminal, still meets 16:00 only if the founders leave by 15:00) | Taxi; hotspot off | Bags; keys returned | Out of the door by 15:00 |
...
If the founders travel by Aerobus, metro or train instead of taxi, the cutoff is 14:00: D2-CT is dropped, the review stops at 13:30 and D2-07 runs 13:30 to 14:00. If a boarding pass shows a departure earlier than 18:30, the early-flight variant in 4B.3 applies from D2-01.
...
Rule for any other booked departure time: end of work = departure minus 4 hours 00 minutes by taxi, or minus 4 hours 30 minutes by Aerobus, metro or train, plus 15 minutes if flying Ryanair or checking a bag (logistics.md section 11: 2 hours 30 minutes at the terminal, 60 minutes door to terminal by taxi or 90 by public transport, 30 minutes to pack and collect bags; transfer times [UNVERIFIED], flight schedules [SOURCED] from the Kiwi.com and lastminute.com connectors on 16 Sep 2026).

Early-flight variant (departure earlier than 18:30; the 17:00 row, work ends 13:00), applied at D2-01 only if a boarding pass says so: D2-01 09:00 to 09:05; D2-02 09:05 to 09:25 (20); D2-03 09:25 to 10:15 (50); D2-BR1 10:15 to 10:30; D2-04 10:30 to 10:55 (25: freeze, one cold run, reset, recording; the cheat test moves to Wed 14 Oct); D2-05 10:55 to 11:15 (20); D2-LU 11:15 to 12:00; D2-06 12:00 to 12:30 (30, hard deadline 12:30: demo, five answers, eight-output check; labels move to Mon 12 Oct); D2-07 12:30 to 13:00. The afternoon break and the reserve are lost and the build falls below the brief's minimum; the founders avoid it by booking 18:30 or later.

### 4B.4 Rules that govern Sunday

Six rules keep Sunday inside its cutoff and are read aloud once at D2-01, after the cutoff is confirmed.
...
2. The reserve (13:30 to 14:00) exists to protect the final review; it is drawn by D2-06 first, by build or D2-02 overruns second, and never for features or new decisions.
...
**Steps.**
1. (2 min) Cutoff confirmed against the boarding passes: airline, departure time, terminal, bag or no bag, Ryanair document check if applicable. If either departure is earlier than 18:30, the cutoff table in logistics.md section 11 is applied now and the early-flight variant starts; if both are 20:00 or later, the extension variant in 4B.3 is declared and the checkpoint card is updated.
...
|---|---|---|---|---|---|
| 1 Title | "Sway turns trusted product recommendations into measurable commerce." | Founders' names and roles; date; "pre-seed discussion draft"; no AI tagline; no infrastructure phrase | The one-thing sentence [FOUNDER ASSERTION, 01_CURRENT_STRATEGY.md]; the D1-02 Q1 sentence (FOUNDER DECISION or Provisional) | None if the Q1 sentence is agreed; if Q1 is Provisional, the slide says "discussion draft" | Tory |
...
| 7 Go-to-market | "Recruit Founding Members where recommendation already happens weekly. Build density in one city before anything else." | Node types; founders recruit personally; the Founding Member Collective bridges the cold start; brands approached only when the data is surprising; expansion within the city | The plan [FOUNDER ASSERTION]; the launch city and nodes OPEN QUESTION unless decided at the workshop | A named city with a reason; three leaders contacted by Thu 15 Oct 22:00 UK; 25 to 50 Founding Members named with consent by Wed 11 Nov; never a member count, waitlist, partnership or CAC | Tory |
| 8 Business model | "Consumers never pay. Commerce funds the network early. Brands pay for intelligence, activation and scale once the community is real." | Four layers; the advocate's share does not shrink | The architecture [FOUNDER ASSERTION]; LTK 13 to 15 per cent "reasonable", https://onbrand.shopltk.com/how-to-choose-the-right-commission-rate-for-influencers [SNIPPET]; HOKA 5 per cent full price and 3 per cent sale, https://www.hoka.com/en/us/hoka-affiliate-program.html [SNIPPET]; supplements 8 to 12 per cent, https://getlasso.co/niche/supplements/ [THIRD-PARTY]; `07_evidence/affiliate_coverage.md` FACT | Whether 80/20 is a principle stated or a number withheld (step 3); what brands pay today, from the calls; the D1-09 first offer as a HYPOTHESIS; never the package prices, the content or reward fees, or any forecast | Tory |
...
| 10 Why it compounds | "Every credible recommendation makes the map more useful. The mechanism is the QR and the link. The asset is the history." | The Trust Map; cross-brand and person-owned; valuable through density; category-specific trust | HYPOTHESIS [FOUNDER ASSERTION]; Duel publicly claims an "Advocate Intelligence Graph", https://www.g2.com/products/duel/reviews [SNIPPET, detail NEEDS SOURCE] | One surprising, true pattern from a tiny cohort after the pilot; the slide says "the asset we intend to build"; never "network effects", "moat" or "proprietary graph" in the present tense | Tory |
...
**Fallback if we disagree, get stuck, or run late.** At 09:26 with items open: decide only the stage word, the three beliefs and the milestone proof points; the 14 headlines from investor_lens.md section 2 stand as Provisional and slide detail is finished on Fri 16 Oct 22:00 UK (deck draft v2, owner Tory); build 3 starts at 09:30 regardless and any overrun is charged to D2-CT. A joint disagreement on a belief or a milestone threshold goes to rule 4 (cheaper to reverse, observable sooner; if tied, closer to the source-of-truth documents), Provisional with dissent verbatim and the Fri 16 Oct 20:00 UK review call (programme choice) as the trigger. A headline neither founder would stand behind is deleted, not softened.
...
1. (25 min) Deck draft v1, slides 1 to 7: for each, the headline as confirmed at D2-02, three to five key points, evidence with its label, the evidence gap with a closure date, and a "do not claim" line.
...
- "Take the five products in your own My 5. For each one, name the affiliate programme, the rate, the cookie window and whether we are approved today. What is Sway's twenty per cent on one hundred pounds of purchases across those five, and would you put that number on a slide?" (challenge_investor-skeptic.md prompt 5; answered from the coverage sheet for slide 8; the number stays off the slide)
...
**Fallback if we disagree, get stuck, or run late.** A never-cut item failing at CP5 (10:05): all remaining build time in build 3 and the fix allowance in build 4 go to that item; items 2, 6 and 7 are cut now; Tory's deck work continues unchanged. The map breaks the page: revert to the list within 10 minutes and log the map as not built. Lovable unusable for more than 20 minutes: no Bolt rebuild on Sunday (not enough time); the prototype is frozen at its last published state, the demo uses that state plus recording 1, and known limitations say so. Tory disagrees with a fix choice: it goes into the checkpoint log and is decided by the cut list (Tory strikes, Blake decides whether a fix is attempted or moved to known limitations, rule 9), never in conversation mid-build.

### 4B.8 D2-04 Build block 4 and C4 commercial block 4 (10:40 to 11:15, 35 minutes)

**Purpose and question to resolve.** Freeze scope (CP6), prove the demo runs cold three times (CP7), try to cheat it, and leave with a reset procedure, a recording and an honest limitations list. Question: do three consecutive cold runs complete with no intervention, each under four minutes, and what did the cheat test find?

**Required inputs.** The prototype at CP5 state; `04_prototype/demo_script_v2.md` skeleton; the D1-05 attribution event table (fakeable and counts-once columns); prototype_feasibility.md section 12 (what the prototype proves and does not); challenge_investor-skeptic.md prompt 8; a stopwatch; a screen recorder on Tory's phone; both phones on mobile data; the Supabase table editor open on the laptop.
...
2. (13 min) Three cold run-throughs, Tory as the recipient from a cleared tab, stopwatch from "can I see that?" to the product page; Blake as the advocate on his phone; Blake fixes only what breaks a run, publishes, and the run restarts from a cleared tab. Times recorded per run.
...
4. (10 min) Blake: reset procedure written in `04_prototype/reset_note.md` and run once (delete `events` where `is_demo_seed` is false; keep the seeds; confirm counters return to the seeded baseline); seed CSVs exported; GitHub sync; screen recording 2 saved; CP7 logged. Tory: `04_prototype/known_limitations_v1.md` under five headings (what is mocked; what is seeded; what is not built; what the events do not prove; what the cheat test found) and demo script v2 timed under four minutes, leading with the hero mechanic.
...
**Tangible output.** The frozen prototype, published and synced; `04_prototype/reset_note.md`; `04_prototype/recording_2` (file name with the time); `04_prototype/seed_csv/` re-exported; `04_prototype/known_limitations_v1.md` (five headings plus the run times); `04_prototype/demo_script_v2.md` timed; the event table in `02_product/product_definition.md` updated with the counts-once rules; log entries D2-04-CP6 and D2-04-CP7 (Demonstration).

**Completion criteria.** Three consecutive runs with no intervention, each under four minutes; the limitations list has all five headings; the counts-once rule is in the event table; the reset procedure has been run once and works; recording 2 plays.
...
**Required inputs.** The frozen prototype at CP7; `04_prototype/fix_list_v2.md` remainder; `04_prototype/known_limitations_v1.md`; the stretch order from the skeleton (the map if not built, else the wallet mock sheet, else IP city lookup capped at 30 minutes); GitHub with the CP7 commit.

**Steps.**
1. (30 min) Remaining fix-list items in demo-impact order, publish after each; anything that breaks a run is reverted from GitHub within 10 minutes.
2. (20 min) One stretch item only if the fix list is empty, in the skeleton's order; a stretch item that is not working at 13:40 is reverted, not finished.
...
- "Which stretch item is next in the skeleton's order, and what is its revert time?"
...
- "Has anything been added that is not on the scope lock sheet? If so, revert it now."
- "Which known-limitation line can be deleted because it was fixed, and which was added?"

**Lead, recorder, artefact owner.** Lead: Blake (build); Tory leads the runs. Recorder: Tory. Artefact owner: Blake (prototype, recording 3); Tory (known limitations).

**Tangible output.** The prototype at its final state; recording 3; known limitations v1 updated; the fix list closed.

**Completion criteria.** Two clean runs; the fix list empty or its remainder in known limitations; no item outside the scope lock sheet in the build.
...
**Required inputs.** Blake's pre-drafted priorities table from `02_product/product_prep_pack.md`; `02_product/product_definition.md` v1; `04_prototype/build_brief_v2.md` and `04_prototype/cut_list.md` as applied; `03_commercial/sales_strategy.md` v1; `03_commercial/deck_draft_v1.md`; the D1-04 claims table; `04_prototype/known_limitations_v1.md`; the follow-through skeleton (section 10 of the skeleton, reproduced in section 7 of this programme); the decision log's action rows; the 00_SOURCE_OF_TRUTH.md MVP boundary; the sales-strategy prompts table below.
...
2. (12 min) Product priorities table, three columns (vision; MVP or Alpha; workshop prototype as built), at least five items each, plus the do-not-build list; Blake writes, Tory challenges each MVP item with "does it test the wedge?"; the prototype column is copied from the scope lock sheet as applied, not from memory.
3. (7 min) Conflicts and labels: each conflict decided or logged as an Open question with a trigger; every claim in the sales strategy and the deck carries Demonstrated / Draft / Hypothesis / Validated finding; anything the prototype contradicts is reworded or removed; event-table rows deferred from D1-05 completed; the sales strategy's nine elements read against the prompts table below and finalised (Tory decides provisionally after restating Blake's objection).
4. (7 min) Execution plan: every decision-log action has an owner and a date within Mon 12 to Sun 18 Oct; the seven follow-through rows confirmed or edited; nothing added without an owner; the external tests from the reconciliation (step 3) placed on the day that can run them.

**Sales strategy final check: the exact prompts.** Tory reads each prompt aloud; the answer already in `03_commercial/sales_strategy.md` v1 is checked against it and labelled; a missing answer is written as OPEN QUESTION with the conversation that would answer it. No number enters unless it came from a dated conversation.
...
**Completion criteria.** Three columns filled with at least five items each; the do-not-build list present; the prototype column matches the frozen build; no unlabelled commercial claim; every action has an owner and a date within Mon 12 to Sun 18 Oct; no unresolved conflict without a trigger; the sales strategy's nine elements each have at least one line.
...
**Steps.**
1. (6 min) Demonstration: Blake runs the reset procedure; then the third cold run with a stopwatch, Blake as the advocate on his phone and Tory as the recipient from a cleared tab, following the demo script beat by beat (table below); the time from "can I see that?" to the product page is recorded; over 15 seconds goes into known limitations and the demo leads with the Sway Link; the proves-and-does-not line is read aloud last.
2. (14 min) The five answers read aloud in the order Q1, Q2, Q5, Q3, Q4 by their owners (Tory for Q1, Q5, Q3 and Q4; Blake for Q2); after each, the non-owner has 60 seconds to challenge as a sceptical investor or brand marketer; the answer is then labelled Decision, Provisional or Draft and the agreed paragraph is written into the five-answers sheet. Roughly two and a half minutes per question plus one minute to write.
3. (12 min) Each of the eight outputs checked against its completion criterion in the deadline register and marked complete, draft or missing with an owner and a date; the consistency checklist run at the same time, one founder reading each check and the other finding the two documents; every failed check becomes a register row.
...
| Question | Read by | Challenged by, as | Label (Decision / Provisional / Draft) | Agreed one-paragraph answer (plain language, under 150 words; Q1 under 120) |
|---|---|---|---|---|
...
**The demo script (six beats, one per acceptance test; the persona names are those chosen at D1-05).**

| Beat | Acceptance test | Who does what | Route | Spoken line (under 15 seconds) | Rows expected |
|---|---|---|---|---|---|
| 1 Locker | Test 1: five products with images and reasons on a phone | Blake (advocate) shows the Locker | `/me` | "This is [advocate persona]'s Locker: five things she actually uses, each with her own reason. No brand put them there." | none |
| 2 Scan | Test 2: the QR on the Pass opens the landing on a second phone within 3 seconds | Tory (recipient) says "can I see that?"; stopwatch starts; scans from a cleared tab; if the Sway Link is hero, the Link is sent to Tory's phone first and the Pass shown second | `/me/pass` to `/p/<code>` | "She asks. He shows the Pass. The phone's camera does the rest: no app, no login, no sign-up." | one `scan` |
| 3 Recommendation page | Test 3: product, "Recommended by [persona]", reason, one dominant button | Tory taps one product | `/r/<slug>` | "Product, who, why, one action, and the line that says [persona] may earn if you buy. That line is there by design." | one `view` |
| 4 Go to product | Test 4: the retailer page loads and a `click_out` row exists | Tory taps the dominant button | `/go/<slug>` | "The click is recorded before the retailer page loads. The retailer's page is theirs, not ours; the redirect is a mock of a tracked link." | one `click_out` |
| 5 Save | Test 5: a `save_email` row (or the Save button that logs the event if cut item 6 was taken) | Tory saves with the test address | `/r/<slug>` | "A recipient can keep it. In the pilot this is the moment a stranger chooses to identify themselves, and we do not yet know how often that happens." | one `save_email` |
| 6 Outcome | Test 6: at least one scan, the event list with a city, "1 pending" (a map dot only if the map was built) | Blake refreshes Trust; the Supabase table is on the laptop as the second view | `/me/trust` | "She sees it happened: scans, clicks, saves, with the city. No purchase is claimed. 'Pending' means eligibility not yet confirmed, and the earnings label shows no currency." | counters change |
| Close | The proves-and-does-not line | Tory reads it | none | "This proves a person can hold a recommendation identity on a phone, another person can reach it with a camera in seconds, and the first person sees it happened. It does not prove demand, retention, affiliate economics, purchase attribution, wallet distribution or brand interest." (prototype_feasibility.md section 12) | none |

**The consistency checklist (run inside step 3; every Fail becomes a register row).**
...
| 5 | Every slide describing a screen describes a built screen; unbuilt screens appear as gaps with dates, not pictures | deck slides 5, 6, 10; scope lock sheet as applied | | Tory |
...
| Legal advice booked and disclosure note v0; marketer thank-you notes with the "which event would you pay to see" ask | D1-03 disclosure date; slide 12; Q3 first offer | Blake; Tory | Tue 13 Oct 22:00 UK | No appointment date by Fri 16 Oct; no dated marketer reply |
| Recipient page cold test with three people not at the workshop; brand conversations 4 and 5 or the first-offer one-pager | D1-02 call (a); D1-05 second screen; Q3 buyer, trigger, offer | Blake; Tory | Wed 14 Oct 22:00 UK (three brand conversations by Fri 23 Oct 22:00 UK if Q3 is Provisional) | Fewer than 3 of 10 recipients tap the dominant action first; the first marketer names a different budget line |
...
| Six cold tests in total and the hero-mechanic review with numbers; Wizard of Oz cohort plan; publisher application status; weekly cadence set | D1-02 call (a); scan behaviour HYPOTHESIS; EARN eligibility | Blake; Tory; both | Sun 18 Oct 21:00 UK | Pass offered in fewer than one in five moments, or median scan-to-page over 15 seconds |
...
**Tangible output.** `01_answers/five_answers.md` (the sheet above, filled, each answer labelled); `00_programme/output_status.md` (eight rows: Output; Completion criterion; Status complete / draft / missing; Owner; Date); `06_decision_log/review_register.md` (the register above); the consistency checklist marked and filed in `00_programme/`; the decision log audited with every entry labelled; the parking lot triaged; the run time from step 1 in known limitations.
...
**Steps.**
1. (10 min) Tory saves the decision log final and exports the five answers and the eight output statuses as one document to both founders (message and shared folder); Blake confirms GitHub sync, and saves the seed CSVs, the reset note and both recordings to `04_prototype/`.
...
3. (10 min) Bags collected; taxi confirmed in the app for 14:45 and the pick-up point walked to; leave by 15:00.
...
- "Do recording 1 and recording 2 play from `04_prototype/` on a phone?"
- "Is every sheet on the wall photographed and legible before it comes down?"
- "Is the taxi confirmed for 14:45 with a pick-up point a taxi can reach?"
...
**Tangible output.** The single source document (`00_programme/sway_workshop_record_2026-10-11.md`, programme choice for the name) sent to both founders; the prototype pack archived in `04_prototype/`; the wall photographs filed.
...
| D2-CT | 13:30 to 14:00 | 30 | Reserve protecting the final review; drawn by D2-06 first, then by earlier overruns in order of occurrence; spent only by the session lead; hard stop 14:00; unused means D2-07 starts early and the founders leave earlier; never features, never a new decision |
...
| 09:05 | A boarding pass shows a departure earlier than 18:30 | The early-flight variant (4B.3) from now; hard stop 13:00; the cheat test moves to Wed 14 Oct | The departure |
| 09:26 | Q4 not decided | Decide only the stage word, the three beliefs and the milestone proof points; the 14 headlines stand as Provisional, slide detail on Fri 16 Oct 22:00 UK; the overrun is charged to D2-CT | Build 3 starts 09:30 |
| 09:30 | Lovable down at the start of build 3 | Bolt fallback opened; the 45-minute rebuild budget comes from build 3 and D2-CT; `/me/trust` is struck and the Supabase table is the outcome view | The never-cut four |
...
| 10:40 | Lovable or Supabase down | No Bolt rebuild (not enough time); freeze at the last published state; demo from recording 1 or 2 and the exported CSVs; known limitations say so | CP6 freeze |
...
| 12:50 | Heavy rain, a transport incident or a Rodalies or metro notice | The review keeps 12:50 to 13:30 and stops at 13:30; D2-CT is dropped; D2-07 runs 13:30 to 14:00; leave by 14:45 | The departure |
...
| 14:45 | Taxi not at the pick-up point | Wait to 14:50, then the Aerobus from Plaça de Catalunya, leaving by 15:00 | At the terminal by 16:00 |
| 15:00 | Not out of the door | Leave now with whatever is packed; nothing is retrieved from a locker across town after 15:00 | At the terminal by 16:00 |
...
5. The single source document on both founders' phones and the prototype pack archived before the founders leave the accommodation by 15:00 (D2-07).
